...
namespace Axton::OpenGL
{
	...
	public:
		...
		virtual void SetSubData(void* data, IVector3 offset, IVector3 size) override;
		virtual void SetSubData(void* data, IVector3 offset, IVector3 size, uint32_t width, uint32_t height, uint32_t depth) override;
